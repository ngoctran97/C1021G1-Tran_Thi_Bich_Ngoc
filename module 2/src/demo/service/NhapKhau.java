...
public class NhapKhau implements INhapKhau{
    private  static ArrayList<Thuc_hanh.C100.modelr.NhapKhau> nhapKhauArrayList = new ArrayList<>();
    ...
    public void write(){
        try {
            ...
            for (Thuc_hanh.C100.modelr.NhapKhau nhapKhau : nhapKhauArrayList){
    ...
    public void aadNewNhapKhau() {
        ...
        Thuc_hanh.C100.modelr.NhapKhau nhapKhau = new Thuc_hanh.C100.modelr.NhapKhau(maSP,name,giaBan,soLuong,nhaSX,giaNK,tinhNK,thueNK);
    ...
    public void searchNhapKhau() {
        ...
        ArrayList<Thuc_hanh.C100.modelr.NhapKhau> arrayList = new ArrayList<>();
        for (int i = 0; i < nhapKhauArrayList.size();i++){
        ...
        if(arrayList.size()== 0){
            ...
            for (Thuc_hanh.C100.modelr.NhapKhau nhapKhau : arrayList){
