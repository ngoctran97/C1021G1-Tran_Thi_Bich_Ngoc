...
public class NhapKhau extends SanPham{
    ...
    public NhapKhau(int id, String maSP, String name, int giaBan, int soLuong, String nhaSX, int giaNK, String tinhNK, double thueNK) {
        super(id, maSP, name, giaBan, soLuong, nhaSX);
        this.giaNK = giaNK;
        this.tinhNK = tinhNK;
        this.thueNK = thueNK;
    }
